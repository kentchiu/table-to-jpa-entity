...
public class ExtendDetailControllerGeneratorTest {
    ...
    public void testApplyTemplate() throws Exception {
        ...
        assertThat(list.get(i++), is("        checkParentExist(masterUuid, detailUuid);"));
        assertThat(list.get(i++), is("        ExtendDetail extendDetail = new ExtendDetail();"));
        assertThat(list.get(i++), is("        DomainUtil.copyNotNullProperties(input, extendDetail);"));
        assertThat(list.get(i++), is(""));
        ...
        assertThat(list.get(i++), is("        extendDetail.setDetail(detail);"));
        assertThat(list.get(i++), is(""));
        ...
        assertThat(list.get(i++), is("        // }"));
        assertThat(list.get(i++), is(""));
        assertThat(list.get(i++), is("        BindException exception = new BindException(extendDetail, extendDetail.getClass().getSimpleName());"));
        assertThat(list.get(i++), is("        Validators.validateBean(exception, extendDetail);"));
        assertThat(list.get(i++), is(""));
        assertThat(list.get(i++), is("        if (exception.hasErrors()) {"));
        assertThat(list.get(i++), is("            throw exception;"));
        assertThat(list.get(i++), is("        }"));
        assertThat(list.get(i++), is(""));
        assertThat(list.get(i++), is("        service.add(extendDetail);"));
        assertThat(list.get(i++), is("        return extendDetail;"));
        assertThat(list.get(i++), is("    }"));
        assertThat(list.get(i++), is(""));
        assertThat(list.get(i++), is(""));
        ...
        assertThat(list.get(i++), is("        checkParentExist(masterUuid, detailUuid);"));
        assertThat(list.get(i++), is("        ExtendDetail extendDetail = service.findOne(uuid).orElseThrow(() -> new ResourceNotFoundException(ExtendDetail.class, uuid));"));
        assertThat(list.get(i++), is(""));
        assertThat(list.get(i++), is("        DomainUtil.copyNotNullProperties(input, extendDetail);"));
        assertThat(list.get(i++), is(""));
        assertThat(list.get(i++), is("        // FIXME  add references"));
        ...
        assertThat(list.get(i++), is("        }"));
        assertThat(list.get(i++), is(""));
        assertThat(list.get(i++), is("        service.update(extendDetail);"));
        assertThat(list.get(i++), is("        return extendDetail;"));
        assertThat(list.get(i++), is("    }"));
        assertThat(list.get(i++), is(""));
